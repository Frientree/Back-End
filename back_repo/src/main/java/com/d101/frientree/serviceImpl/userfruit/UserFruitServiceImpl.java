...
//     private static final String FILE_DIRECTORY = "/audio/";
    ...
    private final AwsS3ObjectStorageUpload awsS3ObjectStorageUpload;
    // 생성자를 통한 의존성 주입
    public UserFruitServiceImpl(ClovaSpeechClient clovaSpeechClient, HttpPostAIRequest httpPostAIRequest, AwsS3ObjectStorageUpload awsS3ObjectStorageUpload) {
        this.clovaSpeechClient = clovaSpeechClient;
        this.httpPostAIRequest = httpPostAIRequest;
        this.awsS3ObjectStorageUpload = awsS3ObjectStorageUpload;
    }
...
//        file.transferTo(new File(filePath));
        System.out.println(awsS3ObjectStorageUpload.uploadFile(file));
